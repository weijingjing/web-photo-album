...
var Zepto = function() {
  ...
  S.init = function(e, i) {
      var r;
      if (!e) return S.Z();
      if ("string" == typeof e) if (e = e.trim(), "<" == e[0] && l.test(e)) r = S.fragment(e, RegExp.$1, i),
      e = null;
      else {
          ...
          e = null;
          else if (l.test(e)) r = S.fragment(e.trim(), RegExp.$1, i),
          e = null;
          else {
              if (i !== t) return n(i).find(e);
              r = S.qsa(a, e)
...
function(t) {
  ...
  $(document).ready(function() {
      ...
      if ('MSGesture' in window) {
          gesture = new MSGesture().gesture.target = document.body
      }
      ...
      function(e) {
          ...
          if (swipeDirectionFromVelocity) {
              touch.el.trigger('swipe').touch.el.trigger('swipe' + swipeDirectionFromVelocity)
          }
      ...
      function(e) {
          ...
          if (e.touches && e.touches.length === 1 && touch.x2) {
              ...
              touch.x2 = undefined.touch.y2 = undefined
          }
      ...
      //     if (delta > 0 && delta <= 250) touch.isDoubleTap = true touch.last = now longTapTimeout = setTimeout(longTap, longTapDelay)
      //     // adds the current touch contact for IE gesture recognition
      //     if (gesture && _isPointerType) gesture.addPointer(e.pointerId);
      // }).on('touchmove MSPointerMove pointermove',
      // function(e) {
      //     if ((_isPointerType = isPointerEventType(e, 'move')) && !isPrimaryTouch(e)) return firstTouch = _isPointerType ? e: e.touches[0] cancelLongTap() touch.x2 = firstTouch.pageX touch.y2 = firstTouch.pageY

      //     deltaX += Math.abs(touch.x1 - touch.x2) deltaY += Math.abs(touch.y1 - touch.y2)
      ...
      //     if ((_isPointerType = isPointerEventType(e, 'up')) && !isPrimaryTouch(e)) return cancelLongTap()
          ...
          if (deltaX < 30 && deltaY < 30) {
              ...
              tapTimeout = setTimeout(function() {
                  ...
                  // var event = $.Event('tap') event.cancelTouch = cancelAll touch.el.trigger(event);
